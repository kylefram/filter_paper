...
This comparison relies upon a loss metric defined to guide the filter selection, and a $\Delta E_{2000}$ measure to compare reconstruction results of filter selection. 
...
We show that our methodology provides accurate reconstruction by evaluating the 24 Macbeth Color Checker patches and computing $\Delta E_{2000}$ under standard illuminant for the CIE 2006 XYZ target functions. 
We compute the relationship between number of filters $k$ and minimum $\Delta E_{2000}$.
